...
public class GLTest
{
	...
	static ArrayList<int[]> makeCube()
	{
		ArrayList<int[]> vertices = new ArrayList<int[]>();

		vertices.add(new int[] { 0, 0, 0 });
		vertices.add(new int[] { 1, 0, 0 });
		vertices.add(new int[] { 1, 0, 1 });
		vertices.add(new int[] { 0, 0, 1 });
		vertices.add(new int[] { 0, 0, 0 });

		vertices.add(new int[] { 0, 1, 0 });
		vertices.add(new int[] { 1, 1, 0 });
		vertices.add(new int[] { 1, 1, 1 });
		vertices.add(new int[] { 0, 1, 1 });
		vertices.add(new int[] { 0, 1, 0 });
